...
<form action="./api/edit_user.php" method="post">
    <table class="mt-5 text-center" style="width:50%;margin:auto;">
        <tr>
            <td>帳號</td>
            <td>密碼</td>
            <td>刪除</td>
...
<div class="mt-5 mx-auto" style="border: 1px solid #1f1f1f;width:80%;height:300px">
    <h2 class="text-center mt-5">新增會員</h2>
    <table style="margin: auto;padding: 80px 0;">
        <tr>
            <td style="text-align:end;width:65%"><input type="text" name="acc" id="acc"></td>
            <td class="clo">帳號</td>
        </tr>
        <tr>
            <td style="text-align:end;width:65%"><input type="password" name="pw" id="pw"></td>
            <td class="clo">密碼</td>
        </tr>
        <tr>
            <td style="text-align:end;width:65%"><input type="password" name="pw2" id="pw2"></td>
            <td class="clo">確認密碼</td>
        </tr>
        <tr>
            <td style="text-align:end;width:65%"><input type="text" name="email" id="email"></td>
